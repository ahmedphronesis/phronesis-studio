...
const SCHEMAS: TemplateSchema[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "perSession", label: "Per-Session Price", type: "text", placeholder: "250 AED" },
      { key: "packageSize", label: "Package Size", type: "text", placeholder: "10 sessions" },
      { key: "packagePrice", label: "Package Price", type: "text", placeholder: "2,000 AED" },
      { key: "packageSavings", label: "Package Savings", type: "text", placeholder: "Save 500 AED" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "hourlyRate", label: "Hourly Rate", type: "text", placeholder: "500 AED / hour" },
      { key: "fixedPrice", label: "Fixed Scope Price", type: "text", placeholder: "8,000 AED" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "fee", label: "Total Fee", type: "text", placeholder: "20,000 AED" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "subtotal", label: "Subtotal", type: "text", placeholder: "8,000 AED" },
      { key: "vatRate", label: "VAT Rate", type: "text", placeholder: "5%", defaultValue: "5%" },
      { key: "vatAmount", label: "VAT Amount", type: "text", placeholder: "400 AED" },
      { key: "total", label: "Total Due", type: "text", placeholder: "8,400 AED" },
