                    ...
                    <div className={`mb-4 p-4 rounded-xl bg-paper-warm border border-teal/20 ${isAR ? "text-right" : ""}`}>
                      <div className={`flex flex-col gap-2.5`}>
                        {featured.editions.map((ed, i) => (
                          <div key={i} className={`flex items-center gap-2 sm:gap-3 ${isAR ? "flex-row-reverse" : ""}`}>
                            <span className="text-[10px] uppercase tracking-[0.15em] text-ink-dim font-mono min-w-[52px] sm:min-w-[70px] flex-shrink-0">
                            ...
                            <a
                              ...
                              className={`${isAR ? "mr-auto" : "ml-auto"} inline-flex items-center gap-1 sm:gap-1.5 bg-teal hover:bg-teal-bright text-paper text-xs font-medium px-2.5 sm:px-3 py-1.5 rounded-full transition-colors whitespace-nowrap flex-shrink-0`}
                            >
